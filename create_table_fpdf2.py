...
class PDF(FPDF):
    ...
    def create_table(self, table_data, title='', data_size = 18, title_size=24, align_data='L', align_header='L', cell_width='even', x_start='x_default',emphasize_data=[], emphasize_style=None,emphasize_color=(0,0,0)): 
        """
        table_data: 
        ...
        if  not isinstance(col_width, list):
            ...
            for i in range(len(data)):
                ...
                self.ln(line_height) # move cursor back to the left margin
        y3 = self.get_y()
        self.line(x_left,y2,x_left,y3)
        self.line(x_left+40,y2,x_left + 40,y3)
